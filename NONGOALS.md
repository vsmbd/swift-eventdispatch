# EventDispatch Non-Goals

This document defines what EventDispatch explicitly does not attempt to do.
...
- Extras are limited to SwiftCore **ScalarValue** so EventInfo remains Codable and Sendable.
- No nested dictionaries or arrays in extras beyond the ScalarValue cases.
